...
- You may cite research references at the end of your paragraphs when appropriate using [number] format.
- Use the reference format [number], to reference the learnings link in corresponding parts of your answer.
- If a paragraph comes from multiple sources, you may list relevant citation numbers, e.g., [1][2].
- Limit citations to 3 per paragraph maximum.
- **IMPORTANT: Do NOT add a References section at the end of the report.**
- **IMPORTANT: Do NOT create detailed reference lists with authors, journals, or publication details.**
- **IMPORTANT: NEVER invent or fabricate references, authors, journals, or publication years.**
- Only use simple numbered citations [1][2][3] if needed, but avoid them if possible to prevent fabrication.`;
